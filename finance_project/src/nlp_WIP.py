...
from finance_project.src import plottingUtil as utilf
from finance_project.src import DATA_PATH
from finance_project.src import text_normalizer
...
complaints = complaints.loc[complaints.consumer_complaint_narrative.notna()][['issue','consumer_complaint_narrative']]
